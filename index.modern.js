...
const TERMS_PDF = 'https://sit2.bmktech.vn/resources/pdf/terms-and-conditions.pdf';
const POLICY_PDF = 'https://doc.bmktech.vn/privacy-policy';
...
var messages_en = {
  ...
  "common.error.400": "The system is updating, please contact BMK for instructions!",
  "common.error.500": "The system is updating, please contact BMK for instructions!",
  ...
  "menu.catProposalManagement": "Cat Proposal Management",
  "menu.roleProductConfig": "Role Product Config",
  "menu.carImageConfig": "Car Image Config",
  "menu.settings": "Settings",
  "menu.ticketPayment": "Ticket Payment Management",
...
var messages_vi = {
  "commom.error.requireField": "Vui lòng nhập {fieldName}",
  ...
  "login.username.required": "Vui lòng nhập tên đăng nhập",
  "login.username.invalid": "Tên đăng nhập không đúng định dạng",
  ...
  "register.email": "Email*",
  "register.fullname.invalid": "Họ và tên không được chứa ký tự đặc biệt",
  "register.fullname.required": "Vui lòng nhập họ và tên",
  "register.email.required": "Vui lòng nhập địa chỉ email",
  "register.email.invalid": "Địa chỉ email không đúng định dạng (Ví dụ: ten@example.com)",
  "register.phoneNumber": "Số điện thoại",
  "register.phoneNumber.required": "Vui lòng nhập số điện thoại",
  "register.phoneNumber.invalid": "Số điện thoại không đúng định dạng (gồm 10 chữ số)",
  "register.refCode": "Mã giới thiệu",
  "register.refCode.invalid": "Mã giới thiệu không đúng hoặc đã hết hạn",
  "register.mustAppcepted": "Vui lòng đọc và đồng ý với điều khoản & điều kiện để tiếp tục",
  "register.registerSuccess": "Yêu cầu đăng ký đối tác đang được xử lý. Vui lòng kiểm tra email để hoàn tất. Xin cảm ơn!",
  ...
  "forgotPassword.username.required": "Vui lòng nhập tên đăng nhập",
  "forgotPassword.email": "Email đăng ký *",
  "forgotPassword.email.required": "Vui lòng nhập địa chỉ email đã đăng ký",
  "forgotPassword.successfull": "Đường dẫn đặt lại mật khẩu đã được gửi tới email của bạn!",
  "forgotPassword.fail": "Số điện thoại hoặc địa chỉ email không khớp với tài khoản",
  "forgotPassword.notFoundEmailSuggestion": "Không tìm thấy địa chỉ email liên kết với tên đăng nhập này",
  "forgotPassword.yourEmailIs": "Địa chỉ email liên kết của bạn là:",
  "menu.home": "Trang chủ",
  "menu.user": "Tài khoản",
  ...
  "menu.ticketPayment": "Quản lý TK Pay",
  "navbar.language.vi": "Tiếng Việt",
  "navbar.language.en": "English",
  ...
  "setting.updateInfo.imageTypeInvalid": "Tệp tải lên không đúng định dạng hình ảnh!",
  "setting.updateInfo.imageExceedSize": "Tệp tải lên vượt quá dung lượng cho phép ({size}MB). Vui lòng chọn tệp nhỏ hơn!",
  ...
  "changePassword.newPassword.required": "Vui lòng nhập mật khẩu mới",
  "changePassword.newPassword.invalid": "Mật khẩu mới phải có tối thiểu 8 ký tự, bao gồm chữ hoa, chữ thường, số và ký tự đặc biệt",
  "changePassword.oldPassword": "Mật khẩu cũ",
  "changePassword.oldPassword.required": "Vui lòng nhập mật khẩu cũ",
  "changePassword.oldPassword.invalid": "Mật khẩu hiện tại không chính xác",
  "changePassword.confirmPassword.required": "Vui lòng nhập lại mật khẩu mới",
  "changePassword.passwordMustMatch": "Mật khẩu nhập lại không khớp",
  "changePassword.confirmMessage": "Bạn có muốn thay đổi mật khẩu?",
  "changePassword.success": "Thay đổi mật khẩu thành công!",
  "changePassword.mustChangeHint": "Để đảm bảo an toàn tài khoản, vui lòng đổi mật khẩu mặc định trước khi tiếp tục!",
  ...
  "createPassword.password.required": "Vui lòng nhập mật khẩu",
  "createPassword.password.invalid": "Mật khẩu phải có tối thiểu 8 ký tự, bao gồm chữ hoa, chữ thường, số và ký tự đặc biệt",
  "createPassword.enterThePassword": "Nhập lại mật khẩu *",
  "createPassword.passwordMustMatch": "Mật khẩu nhập lại không khớp",
  ...
  "createPassword.enterThePassword.required": "Vui lòng nhập lại mật khẩu mới",
  "completeInformation.title": "Bổ sung thông tin",
  "completeInformation.idType": "Loại giấy tờ tùy thân",
  "completeInformation.idType.required": "Vui lòng chọn loại giấy tờ tùy thân",
  "completeInformation.nbrPer": "Số giấy tờ tuỳ thân",
  "completeInformation.nbrPer.required": "Vui lòng nhập số giấy tờ tùy thân",
  "completeInformation.nbrPer.invalid": "Số giấy tờ tùy thân không đúng định dạng",
  "completeInformation.dateOfBirth": "Ngày sinh",
  "completeInformation.dateOfBirth.required": "Vui lòng nhập ngày sinh",
  "completeInformation.address": "Địa chỉ",
  "completeInformation.address.required": "Vui lòng nhập địa chỉ cụ thể",
  "completeInformation.gif": "Mã giới thiệu",
  "completeInformation.branch": "Chi nhánh",
  "completeInformation.branch.required": "Vui lòng chọn chi nhánh ngân hàng",
  "completeInformation.accountNbr": "Số tài khoản",
  "completeInformation.accountNbr.required": "Vui lòng nhập số tài khoản ngân hàng",
  "completeInformation.personalInfo": "Hộ chiếu*",
  "completeInformation.gender": "Giới tính",
  "completeInformation.province": "Tỉnh/Thành Phố",
  "completeInformation.province.required": "Vui lòng chọn Tỉnh/Thành phố",
  "completeInformation.district": "Quận/Huyện",
  "completeInformation.district.required": "Vui lòng chọn Quận/Huyện",
  "completeInformation.ward": "Phường/Xã",
  "completeInformation.ward.required": "Vui lòng chọn Phường/Xã",
  "completeInformation.bank": "Ngân hàng",
  "completeInformation.bank.required": "Vui lòng chọn Ngân hàng",
  ...
  "socialLogin.addInfo.info": "BMK cần bạn bổ sung các thông tin bên dưới để hoàn tất đăng ký tài khoản.",
  ...
  "verifyAccount.didNotReceiveCode": "Không nhận được mã xác thực?",
  ...
  "verifyAccount.otp.info": "Vui lòng nhập mã xác thực (OTP) đã được gửi về số điện thoại <b>{phoneNumber}</b>",
  "verifyAccount.otp.verify": "Xác nhận",
  "verifyAccount.otp.getOtp": "Lấy lại mã OTP",
  "verifyAccount.otp.registerSuccess": "Đăng ký thành công! Đường dẫn kích hoạt tài khoản đã được gửi đến email của bạn.",
  ...
  "bonusPoint.bonus": "BMK tặng điểm thưởng cho hợp đồng hoàn thành",
  "bonusPoint.paymentContract": "Đã dùng điểm thưởng BMK để thanh toán hợp đồng",
  "bonusPoint.withDrawval": "Đã dùng điểm thưởng BMK để rút tiền",
  "bonusPoint.gift": "Đã dùng điểm thưởng BMK để đổi quà",
...
const ContactTab = () => {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Row, {
    ...
    href: "mailto:lienhe@bmktech.com.vn",
    target: "_blank"
  }, "lienhe@bmktech.com.vn")), /*#__PURE__*/React.createElement("div", {
