...
var messages_vi = {
	...
	"common.error.400": "Hệ thống đang trong quá trình cập nhật, vui lòng liên hệ BMK để được hướng dẫn!",
	"common.error.500": "Hệ thống đang cập nhật, vui lòng liên hệ BMK để được hướng dẫn!",
...
const BaseFormDatePicker = ({
  ...
  return /*#__PURE__*/React.createElement(FormGroup, null, /*#__PURE__*/React.createElement(Field, {
    ...
    className: `form-control position-relative ${!disabled ? 'bg-white' : 'bg-disabled'} ${_isRequired && getPropObject(errors, fieldName) && getPropObject(touched, fieldName) && 'is-invalid'} ${className}`,
