...
const API_REGISTER = '/bpm/onboarding/api/authenticate/register';
const API_VERIFY_ACCOUNT = '/bpm/onboarding/api/authenticate/verify-account';
const API_VERIFY_PHONENUMBER = '/bpm/onboarding/api/authenticate/verify-phone-number';
const API_GET_USER = '/bpm/user/api/users';
const API_USER_SETTINGS = '/bpm/user/api/user-settings';
const API_UPDATE_USER_INFO = '/bpm/user/api/update-user-info';
const API_GET_NAV_CONFIGS = '/bpm/accesscontrol/api/roles';
const API_GET_USER_ROLES = '/bpm/accesscontrol/api/user-group-roles';
const API_CREATE_PASSWORD = '/bpm/onboarding/api/authenticate/create-new-password';
const API_GET_USER_BY_REGISTER_TOKEN = '/bpm/onboarding/api/authenticate/get-partner';
const API_COMPLETE_INFO = '/bpm/onboarding/api/authenticate/complete-info';
const API_FORGOT_PASSWORD = '/api/authenticate/forgot-password';
const API_RESET_PASSWORD = '/api/authenticate/reset-password';
const API_EMAIL_SUGGESTION = '/bpm/user/api/authenticate/email-suggestion';
const API_GET_MY_NOTIFICATIONS = '/bpm/notification/api/my-notification';
const API_CHECK_NEW_NOTIFICATIONS = '/bpm/notification/api/authenticate/notifications-es';
const API_GET_NOTIFICATION_FROM_ESPUBLIC = '/bpm/notification/api/authenticate/user-notifications-es';
const API_UPDATE_NOTIFICATION = '/bpm/notification/api/authenticate/my-notifications/status';
const API_UPDATE_ALL_NOTIFICATION_STATUS = '/bpm/notification/api/authenticate/my-notifications-status';
const API_GET_ALL_BONUS_TRANSACTION_BY_USER = '/bpm/bonusmanager/api/bonus-transaction/by-user';
const API_GET_ALL_BONUS_WITHDRAWVAL_TRANSACTION_BY_USER = '/bpm/bonusmanager/api/bonus-with-drawval-transactions/by-user';
const API_GET_USER_SOCIAL = '/api/user-social-network';
const API_GET_BONUS_BY_USER_ID = '/bpm/bonusmanager/api/userBonusBalance';
const API_R_200 = 200;
const API_GET_CITIES_BY_COUNTRY = '/bpm/datacollection/api/citiesbycountry';
const API_GET_DISTRICTS_BY_CITY = '/bpm/datacollection/api/districtsbycity';
const API_GET_WARDS_BY_CITY = '/bpm/datacollection/api/wardsbydistrict';
const API_GET_BANKS = '/bpm/datacollection/api/allBanks';
const API_UPLOAD_FILE = '/bpm/file/api/upload';
const API_GET_FILE = '/bpm/file/api/file';
...
const UserDropdown = () => {
  ...
  const { appId } = useSelector(state => state.customizer);
  ...
  return /*#__PURE__*/React.createElement(DropdownMenu, {
    ...
    onClick: e => {
      ...
      } else handleNavigation(e, '/app/change-password');
    }
...
var messages_en = {
  ...
  "menu.socialRequestLogManagement": "QLBC Thị Trường",
  "menu.manageCollaboratorProfile": "Manage Collaborator Profile",
  "menu.leaveManagement": "Leave Management",
  "menu.leaveRequest": "Leave Request",
  "menu.leaveInbox": "Leave Inbox",
...
var messages_vi = {
  ...
  "menu.socialRequestLogManagement": "QLBC Thị Trường",
  "menu.manageCollaboratorProfile": "Quản lý hồ sơ",
  "menu.leaveManagement": "Quản lý nghỉ phép",
  "menu.leaveRequest": "Tạo mới",
  "menu.leaveInbox": "Hồ sơ đến",
	"navbar.language.vi": "Tiếng Việt",
	"navbar.language.en": "English",
  ...
  return   /*#__PURE__*/React.createElement(FormGroup, {
        ...
        /*#__PURE__*/React.createElement(React.Fragment, null,
            /*#__PURE__*/React.createElement(Field, {
                ...
                // Thêm destructuring cho field và form
                /*#__PURE__*/React.createElement(React.Fragment, null,
